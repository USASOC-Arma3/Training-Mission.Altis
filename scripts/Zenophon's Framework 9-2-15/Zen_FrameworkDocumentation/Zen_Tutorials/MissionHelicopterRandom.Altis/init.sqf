...
titleText ["Good Luck", "BLACK FADED", 1.4];
...
_markerArray = [_markerArray,[["urban",50],["forest",50],["water",50]]] call f_filtermarkersbyParm;
...
_landingPosition = [_landingMarker,0,0,1,0,0,[1,0,12],0,0,[1,10],[1,[0,0,-1],12]] call Zen_FindGroundPosition;
