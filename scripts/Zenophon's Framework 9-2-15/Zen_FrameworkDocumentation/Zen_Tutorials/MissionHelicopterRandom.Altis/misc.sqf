...
f_createMarkersfromArray = {
	private ["_ppositionarray","_pmarkersize","_newMarker","_alphaValue","_markerarray"];
	// Assign local variables to center and marker size function parameters
	...
	// Return array of markers to calling function
	_markerarray
};
...
f_filtermarkersbyTerrain = {
	...
	_pmarkerarray = +_parmarray;	// Filter a copy of the array argumen
