...
_MortarGuard = [_ObjectivePos, east, "militia", [2, 3]] call Zen_SpawnInfantry;
...
_TownGuard = [_PatrolPosition, east, "infantry", [1,3]] call Zen_SpawnInfantry;
0 = [_TownGuard, "BriefingMissionOPFOR"] spawn Zen_OrderInfantryPatrol;
